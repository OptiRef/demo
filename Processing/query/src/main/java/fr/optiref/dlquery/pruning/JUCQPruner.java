...
public class JUCQPruner extends Pruner {
	...
	public String pruneUCQ(String query, String dlpquery, boolean stats , boolean docost) throws SQLException {
		...
		if(stats){
			...
			String queryfilename = baseDirectory + "/"+properties.get("query.savesubcq.directoryPath").toString();

			//String queryfilename = baseDirectory + "/"+properties.get("stats.output.prefix").toString()+properties.get("ontology.name").toString()+"/Queries/Reformulations";

			//queryfilename += String.format("%s.JUCQ.txt", qid);
			queryfilename += String.format("%s.txt", qid);
	...
	public  String pruneQuery(String query, String dlpquery, boolean stats, boolean docost) throws SQLException {
		...
		if(stats){
			...
			String qid = QueryUtils.getQName(dlpquery);
			String queryfilename = baseDirectory+ "/"+properties.get("query.savesubcq.directoryPath").toString();// + "/"+properties.get("exps.output").toString();
