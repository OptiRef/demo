...
public class USCQ {
	...
	public USCQ(Properties _properties) {
		...
		ontologypath = baseDirectory + "/"+properties.get("compact.ontology").toString();
		//querypath    = baseDirectory + "/"+properties.get("compact.queryDir").toString();
		querypath    = properties.get("compact.queryDir").toString();
